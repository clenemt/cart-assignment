...
var $ = function () {
    ...
    var $ = {
        ...
        ownerDocument: function ownerDocument(element) {
        ...
        on: function on(element, eventName, handler, capture, one) {
        ...
        off: function off(element, eventName, handler, capture) {
            var events = eventName;
        ...
        findAll: function findAll(element, selector, one) {
        ...
        first: function first(element) {
            ...
            while (!found && element) {
                if (element.nodeType === 1) found = true;else element = element.nextSibling;
            }
            return element;
        },
        ...
        attr: function attr(element, _attr, value) {
            ...
            if (typeof _attr === 'string') {
                if (value === undefined) {
                    ...
                    return element.getAttribute(_attr) || element[_attr];
                } else {
        ...
        toggleClass: function toggleClass(element, className, state) {
            (state === undefined ? !$.hasClass(element, className) : state) ? $.addClass(element, className) : $.removeClass(element, className);
        },
        ...
        css: function css(element, prop, value) {
            ...
            if (typeof prop === 'string') {
                if (value === undefined) {
                    ...
                    return getComputedStyle(element).getPropertyValue($.hyphenate(prop)) || element.style[$.camelize(prop)];
                } else {
                    props = {};
                    props[prop] = value;
                }
